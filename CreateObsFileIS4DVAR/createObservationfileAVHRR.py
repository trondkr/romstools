...
def help():
    ...
    from the AVHRR database using OpenDAP. The North Sea domain consists
    of 4 different AVHRR tiles that need to be extracted separately, then assembled into
